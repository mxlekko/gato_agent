...
`project://runtime-assets/project-runtime/workspace/skills/special-custom-product-solution/references/output_schema.json`

读取方式：

```bash
cat project://runtime-assets/project-runtime/workspace/skills/special-custom-product-solution/references/output_schema.json
```
