...
`/Users/gato-pm/Desktop/API_副本/runtime-assets/project-runtime/workspace/skills/sales-opportunity-advisor/references/output_schema.json`
...
12. 草拟最终业务 payload，字段以提示词文件与 output schema 为准，至少包含：
    ...
    - `adviceText`
    - `nextActions`
13. 读取 `/Users/gato-pm/Desktop/API_副本/runtime-assets/project-runtime/workspace/skills/sales-opportunity-advisor/references/output_schema.json`。
